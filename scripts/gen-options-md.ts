...
[
  ...
  "_string_",
  "-",
  "[API key][55] to use when fetching live token price data"
],
// enabled
[
  "enabled",
  "_bool_",
  "`true`",
  "Generate gas reports for the hardhat `test` command"
],
// etherscan
[
  "etherscan",
...
[
  ...
  "(Incurs a small performance penalty on test startup when `true`)"
],
// excludeContracts
[
  "excludeContracts",
  "_string[]_",
  "`[]`",
  "Contracts or folders to exclude from report. Ex: `['MyContract.sol', 'MyFolder/']`" +
  "(Paths are relative to hardhat's `paths.sources` setting - usually `contracts`)."
],
// includeIntrinsicGas
[
  "includeIntrinsicGas",
  "_bool_",
  "`true`",
  "Include standard 21_000 + calldata bytes fees in method gas usage data. (Setting to false " +
...
[
  ...
  "_string_",
  "`ethereum`",
  "Auto-configure reporter to emulate specified L1 network.  See [supported networks][6] "
],
// L2
[
  "L2",
  "_string_",
  "-",
  "Auto-configure reporter to emulate specified L2 network (See [supported networks][6]"
],
// offline
[
  "offline",
  "_bool_",
  "`false`",
  "Never make a remote call to fetch data"
],
// optimismHardfork
[
  "optimismHardfork",
...
[
  ...
  "_bool_",
  "`false`",
  "Skip writing the table to std out. (Useful if you only want to write JSON to file)"
],
outputSubtitle,
// outputFile
[
  ...
  "_string_",
  "-",
  "Relative path to a file to output terminal table to (instead of stdout)"
],
// outputJSONFile
[
  "outputJSONFile",
