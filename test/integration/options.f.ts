 ...
 */
describe("Options F (OPStack:base with live pricing & `reportPureAndViewMethods`)", function () {
  ...
  const configPath = "./hardhat.options.f.config.ts";
